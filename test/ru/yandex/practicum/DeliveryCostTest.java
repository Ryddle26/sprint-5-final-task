...
public class DeliveryCostTest {
    ...
    void standardDeliveryCostTest() {
        StandardParcel standardParcel = new StandardParcel("Книга", 2,
                "Астана", 6);
    ...
    void fragileDeliveryCostTest() {
        FragileParcel fragileParcel = new FragileParcel("Ваза", 5,
                "Караганда", 10);
    ...
    void perishableDeliveryCostTest() {
        PerishableParcel perishableParcel = new PerishableParcel("Печенье", 3,
                "Павлодар", 20, 10);
